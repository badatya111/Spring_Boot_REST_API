...
public class PersonServiceImpl implements PersonService{
    ...
    @Override
    public List<Person> getByPersionSalary(Double minSalary, Double maxSalary) {
        return null;
    }

    @Override
    public Page<Person> search(String name, Integer minAge, Integer maxAge, Double minSalary, Double maxSalary, String city, Pageable pageable) {
        return null;
    }

    @Override
    public Page<Person> search(String id, Integer minSalary, Integer maxSalary, Pageable pageable) {
        return null;
    }


    public List<Person> getPersionSalary(Double minSalary,Double maxSalary){
        return personRepository.findPersionBySalaryBetween(minSalary,maxSalary);
    }

    public Page<Person> search(String name, Integer minAge, Integer maxAge,Double minSalary,Double maxSalary, String city,String primaryLanguage, Pageable pageable) {
        ...
        if(minSalary !=null && maxSalary !=null){
            criteria.add(Criteria.where("age").gte(minSalary).lte(maxSalary));
        }
        ...
        if(primaryLanguage !=null && !primaryLanguage.isEmpty()){
            criteria.add(Criteria.where("languages.primaryLanguage"));
        }
