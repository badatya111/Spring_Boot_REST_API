...
public class PersonController {
    ...
    @GetMapping("/salary")
    public List<Person> getByPersionSalary(@RequestParam Double minSalary, @RequestParam Double maxSalary){
        return personService.getByPersionSalary(minSalary,maxSalary);
    }
    ...
    public Page<Person> searchPerson(
        ...
        return personService.search(name,minAge,maxAge,minSalary,maxSalary,city,pageable);
    }
